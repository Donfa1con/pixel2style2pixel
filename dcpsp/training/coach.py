...
from dcpsp.criteria import id_loss, moco_loss, w_norm
from dcpsp.criteria.lpips.lpips import LPIPS
from dcpsp.datasets.images_dataset import ImagesDataset
from dcpsp.models.psp import pSp
from dcpsp.training.ranger import Ranger
from dcpsp.utils import common, train_utils
...
class Coach:
    def __init__(self, opts):
        ...
        if self.opts.use_wandb:
            from dcpsp.utils.wandb_utils import WBLogger
    ...
    def validate(self):
        ...
        for batch_idx, batch in enumerate(self.test_dataloader):
            ...
            self.parse_and_log_images(
                id_logs, x, y, y_hat, title="images/test/faces", subscript="{:04d}".format(batch_idx)
            )
