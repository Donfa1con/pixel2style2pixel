...
from dcpsp.datasets import augmentations
...
class SketchToImageTransforms(TransformsConfig):
    ...
    def get_transforms(self):
        transforms_dict = {
            ...
            "transform_source": transforms.Compose([transforms.Resize((256, 256)), transforms.ToTensor()]),
            "transform_test": transforms.Compose(
                [
                    transforms.Resize((256, 256)),
                    transforms.ToTensor(),
...
class SegToImageTransforms(TransformsConfig):
    ...
    def get_transforms(self):
        transforms_dict = {
            ...
            "transform_source": transforms.Compose(
                [transforms.Resize((256, 256)), augmentations.ToOneHot(self.opts.label_nc), transforms.ToTensor()]
            ),
            "transform_test": transforms.Compose(
                [
                    transforms.Resize((256, 256)),
